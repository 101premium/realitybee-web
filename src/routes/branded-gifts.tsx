...
const items: Item[] = [
  ...
  { name: "Royal Throw Pillow", blurb: "Full-colour printed throw pillows in premium fabrics.", image: "https://hafexcreation.com/assets/images/shop/popular-products/custom-royal-pillow-print-and-design-in-lagos-nigeria.jpg", moq: MOQ, specs: ["Size: 18\" x 18\" (custom sizes on request)", "Material: Premium velvet, linen or satin cover with hollow-fibre inner filling", "Finishing: Vibrant full sublimation print on front, back and sides with concealed zip", "Price: Royal throw pillow printing starting from ₦5,500 per unit (Best Quality)", "Delivery: 3-5 working days at your doorstep in Lagos • 5-7 working days Nationwide"] },
  { name: "Award Plaque", blurb: "Personalised crystal, wood and acrylic award plaques.", image: "https://hafexcreation.com/assets/images/shop/popular-products/custom-award-plaque-printing-in-lagos-nigeria.jpg", moq: MOQ, specs: ["Material: Premium crystal, wood or acrylic on a solid wooden base", "Size: Small (6\"), medium (8\") and large (10\") — custom sizes on request", "Finishing: UV full-colour printing or laser engraving with velvet-lined gift box", "Price: Custom award plaque starting from ₦12,500 per unit (Best Quality)", "Delivery: 4-5 working days at your doorstep in Lagos • 5-7 working days Nationwide"] },
  { name: "Luxury Gift Box", blurb: "Bespoke branded gift boxes for corporate hampers.", image: "https://hafexcreation.com/assets/images/shop/popular-products/customized-luxury-box-printing-in-lagos-nigeria.jpg", moq: MOQ, specs: ["Material: Rigid 1200-1500gsm greyboard wrapped in premium art paper or PU leather", "Size: Custom dimensions with EVA foam or satin inserts to fit your items", "Finishing: Full-colour print with foil stamping, embossing or spot UV; magnetic or ribbon-tie closure", "Price: Luxury branded gift box starting from ₦4,500 per unit (Best Quality)", "Delivery: 5-7 working days at your doorstep in Lagos • 7-10 working days Nationwide"] },
  { name: "Branded Mini Hand Fan", blurb: "Lightweight branded fans — a hit at outdoor events.", image: "https://hafexcreation.com/assets/images/shop/popular-products/quality-branded-mini-hand-fan-printing-in-lagos-nigeria.jpg", moq: MOQ, specs: ["Material: Durable ABS plastic body with 3-speed rechargeable USB motor", "Size: Handheld 18cm x 8cm mini fan with lanyard", "Finishing: Full-colour UV logo print on the handle and blades cover", "Price: Branded mini hand fan starting from ₦3,800 per unit (Best Quality)", "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide"] },
  { name: "Custom Umbrella", blurb: "Full-colour umbrellas for staff, clients and promotions.", image: "https://hafexcreation.com/assets/images/shop/popular-products/custom-umbrella-printing-in-lagos-nigeria.jpg", moq: MOQ, specs: ["Material: Waterproof 190T polyester canopy with fibreglass ribs and wooden or metal handle", "Size: 23\" x 8k straight umbrella (golf and foldable options available)", "Finishing: Full-colour sublimation or silk-screen printing across one or all panels", "Price: Custom branded umbrella starting from ₦6,500 per unit (Best Quality)", "Delivery: 3-5 working days at your doorstep in Lagos • 5-7 working days Nationwide"] },
];
