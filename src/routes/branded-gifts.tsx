...
const items: Item[] = [
  {
    ...
    specs: [
      ...
      "Price: Customized t-shirt price starting $8,000 per one (Best Quality)",
  ...
  },
  {
    ...
    specs: [
      ...
      "Price: Customized t-shirt price starting $6,500 per one (Best Quality)",
      "Delivery: 2-3 working days at your doorstep in Lagos • 3-4 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Finishing: Full-color borderless / Flock printing or monogram embroidery print (optional).",
      "Price: Quality Branded Hoodie Printing starting from $28,500 per one (Best Quality)",
  ...
  },
  {
    ...
    specs: [
      ...
      "Price: Customized Apron price starting $13,000 per one (Best Quality)",
      "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: Customized Plastic Pen Printing starting from $600 per copy (Best Quality).",
  ...
  },
  {
    ...
    moq: MOQ,
    specs: [
      "Material: Premium AAA-grade coated ceramic mug",
      ...
      "Price: Coated mug printing starting from $3,500 per unit (Best Quality)",
      "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: Cork-bottom mug printing starting from $4,500 per unit (Best Quality)",
      "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: Insulated tumbler branding starting from $18,500 per unit (Best Quality)",
  ...
  },
  {
    ...
    specs: [
      ...
      "Price: Custom 3D Logo puff price starting $4,000 per one (Best Quality)",
      "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: Customized face cap printing starting from $3,500 per unit (Best Quality)",
      "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Finishing: Full-color borderless / Flock printing or monogram embroidery print (optional)",
      "Price: Customized Reflective Jacket price starting $7,500 per one (Best Quality)",
      "Delivery: 2-3 working days at your doorstep in Lagos • 3-4 working days Nationwide",
    ],
  },
  {
    ...
    moq: MOQ,
    specs: [
      "Material: 100% soft, absorbent cotton (400 gsm)",
      ...
      "Price: Custom face towel printing starting from $2,500 per unit (Best Quality)",
      "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide",
    ],
  },
  {
    ...
    moq: MOQ,
    specs: [
      "Material: 100% premium combed cotton (500 gsm)",
      "Size: 70cm x 140cm (custom sizes on request)",
      "Colours: White, cream, navy, black and custom shades",
      "Finishing: Flat or 3D thread embroidery of your logo, individually folded and packaged",
      "Price: Custom bath towel printing starting from $8,500 per unit (Best Quality)",
      "Delivery: 3-5 working days at your doorstep in Lagos • 5-7 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: A5 executive jotter printing starting from $4,500 per unit (Best Quality)",
      "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: Custom paper bag printing starting from $850 per unit (Best Quality)",
      "Delivery: 3-5 working days at your doorstep in Lagos • 5-7 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: Royal throw pillow printing starting from $5,500 per unit (Best Quality)",
      "Delivery: 3-5 working days at your doorstep in Lagos • 5-7 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: Custom award plaque starting from $12,500 per unit (Best Quality)",
  ...
  },
  {
    ...
    specs: [
      ...
      "Price: Luxury branded gift box starting from $4,500 per unit (Best Quality)",
  ...
  },
  {
    ...
    specs: [
      ...
      "Price: Branded mini hand fan starting from $3,800 per unit (Best Quality)",
      "Delivery: 3-4 working days at your doorstep in Lagos • 4-5 working days Nationwide",
    ],
  },
  {
    ...
    specs: [
      ...
      "Price: Custom branded umbrella starting from $6,500 per unit (Best Quality)",
      "Delivery: 3-5 working days at your doorstep in Lagos • 5-7 working days Nationwide",
    ],
  },
];
      ...
      <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-br from-accent/15 via-background to-primary/10">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-20">
          ...
          <p className="mt-4 max-w-2xl text-base text-muted-foreground">
            Corporate gifts, promotional items and team merch — apparel, drinkware, stationery and
            awards, all beautifully branded with your logo.
          </p>
      ...
      <section id="catalog" className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {items.length} items — MOQ and pricing on request.
          </p>
        </div>
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-12 sm:px-6 md:grid-cols-[1fr_auto] md:items-center">
          ...
          <div className="grid gap-2 text-sm">
            ...
            <span className="flex items-center gap-2">
              <MapPin className="h-4 w-4 text-accent" /> 5 Ikosi Road, Oregun, Ikeja, Lagos
            </span>
          </div>
        </div>
      </section>
